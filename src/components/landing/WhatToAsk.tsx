          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-card/90 to-card/60 backdrop-blur-xl rounded-3xl p-6 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-3 flex-1">
                  <div className="bg-primary/5 rounded-2xl p-4 border border-primary/10">
                    <p className="font-semibold text-primary">"What is the cost of LASIK eye surgery?"</p>
                  </div>
                  <div className="bg-muted/30 rounded-2xl p-4">
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      Learn about average pricing, factors affecting cost, and typical recovery expectations.
                    </p>
                    <div className="flex gap-2 mt-3">
                      <span className="px-2 py-1 bg-primary/10 text-primary text-xs rounded-full">Cost Breakdown</span>
                      <span className="px-2 py-1 bg-primary/10 text-primary text-xs rounded-full">Recovery Timeline</span>
                    </div>
                  </div>
                </div>
              </div>
